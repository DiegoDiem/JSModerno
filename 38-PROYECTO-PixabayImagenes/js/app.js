...
function mostrarAlerta(mensaje){
    ...
    if(!existeAlerta){
        ...
        alerta.classList.add('bg-red-100','border-red-400','text-red-700','py-3','rounded','max-w-lg','mx-auto','mt-6','text-center');
...
function buscarImagenes(){
    ...
    const key ='26037376-fab986837aa0e0525ce809913';
...
function imprimirPaginador(){
    ...
    while (true) {
        ...
        //Caso contrario, genera un botoón por cada elemento en el generador
